                        ...
                        <div class="card-body">
                            <form action="" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="asal_sekolah" value="<?= set_value('asal_sekolah') ?>" class="form-control" id="asal_sekolah"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alamat" value="<?= set_value('nama') ?>" class="form-control" id="alamat"
                                        placeholder="Alamat">
